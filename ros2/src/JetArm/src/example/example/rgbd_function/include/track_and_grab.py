...
class TrackAndGrabNode(Node):
    ...
    def pick(self, position):
        ...
        if res.pulse:
            ...
            time.sleep(1)
            set_servo_position(self.joints_pub, 1.5, ((1, 125), (2,550), (3, 120), (4, 150), (5, 500)))
            time.sleep(1.5)
            set_servo_position(self.joints_pub, 1, ((1, 125), (2, 550), (3, 120), (4, 170), (5, 500), (10, 200)))
            time.sleep(1.5)
                        ...
                        if abs(self.last_pitch_yaw[0] - p_y[0]) < 3 and abs(self.last_pitch_yaw[1] - p_y[1]) < 3:
                            if time.time() - self.stamp > 2:
                                ...
                                if valid_depths.size == 0:
                                    ...
                                    dist = 0.15  # 或设置一个默认值，如 dist = 0.15
                                else:
