[JETARM_VENTUNOQ_APPLICATION_GUIDE.md](https://github.com/user-attachments/files/31441787/JETARM_VENTUNOQ_APPLICATION_GUIDE.md)
...
This guide allows another engineer to reproduce, commission, operate, tune, troubleshoot, and recover the complete JetArm solution. The pipeline is camera-based face/person detection in Arduino App Lab → UDP JSON → ROS 2 bridge → JetArm bus servo controller. WebUI and persistent voice controls share the same control path.
